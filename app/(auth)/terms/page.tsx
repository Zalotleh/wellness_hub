      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="prose prose-green max-w-none">
            ...
            {/* Medical Disclaimer */}
            <section className="mb-8 bg-amber-50 border-2 border-amber-200 rounded-lg p-6">
              <h2 className="text-2xl font-bold text-amber-900 mb-4">⚠️ 2. Medical Disclaimer</h2>
              <p className="text-amber-900 leading-relaxed mb-4 font-semibold">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-4">
                <h3 className="font-bold text-gray-900 mb-2">Premium & Family Plans</h3>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-gray-700 font-medium">5x5x5 Wellness Hub</p>
                <p className="text-gray-600 text-sm">Email: legal@5x5xwellnesshub.com</p>
                <p className="text-gray-600 text-sm">Support: support@5x5xwellnesshub.com</p>
              </div>
            </section>

            {/* Acknowledgment */}
            <section className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
              <h2 className="text-2xl font-bold text-green-900 mb-4">15. Acknowledgment</h2>
