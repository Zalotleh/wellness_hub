          ...
          <div className="prose prose-green max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-700 text-sm mb-2">When you register for an account, we collect:</p>
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  <h3 className="font-bold text-gray-900 mb-2">Health and Wellness Data</h3>
                  <p className="text-gray-700 text-sm mb-2">To provide personalized recommendations, we collect:</p>
                  <ul className="list-disc pl-6 text-gray-700 text-sm space-y-1">
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-700 text-sm mb-2">We automatically collect:</p>
                  <ul className="list-disc pl-6 text-gray-700 text-sm space-y-1">
                ...
                <div className="bg-amber-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-700 text-sm mb-2">For premium subscriptions:</p>
                  <ul className="list-disc pl-6 text-gray-700 text-sm space-y-1">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6 space-y-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">✓ Portability</h3>
                  <p className="text-gray-700 text-sm">Export your data in a machine-readable format</p>
                </div>
                
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">✓ Objection</h3>
                  <p className="text-gray-700 text-sm">Object to processing of your personal data</p>
                </div>
                
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">✓ Restriction</h3>
                  <p className="text-gray-700 text-sm">Request restriction of processing</p>
                </div>

                <div>
                  <h3 className="font-bold text-gray-900 mb-1">✓ Withdraw Consent</h3>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-3 mb-4">
                <div className="bg-blue-50 rounded p-3">
                  ...
                  <p className="text-gray-700 text-sm">Required for authentication and core functionality (cannot be disabled)</p>
                </div>
                
                <div className="bg-green-50 rounded p-3">
                  <h3 className="font-bold text-gray-900 text-sm mb-1">Preference Cookies</h3>
                  <p className="text-gray-700 text-sm">Remember your settings and preferences (measurement system, language)</p>
                </div>
                
                <div className="bg-purple-50 rounded p-3">
                  <h3 className="font-bold text-gray-900 text-sm mb-1">Analytics Cookies</h3>
                  <p className="text-gray-700 text-sm">Help us understand how users interact with our platform (can be disabled)</p>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-600 text-sm mb-1"><strong>Email:</strong> privacy@5x5xwellnesshub.com</p>
                <p className="text-gray-600 text-sm mb-1"><strong>Support:</strong> support@5x5xwellnesshub.com</p>
                <p className="text-gray-600 text-sm mb-1"><strong>Data Protection Officer:</strong> dpo@5x5xwellnesshub.com</p>
