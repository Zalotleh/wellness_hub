    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-700 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-200 mb-4">Please sign in to debug subscription data.</p>
          <button
            onClick={() => signIn()}
            ...
            <div>
              ...
              {debugData?.databaseData ? (
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <p className="text-gray-600 dark:text-gray-200">Loading database data...</p>
                </div>
              )}
            </div>
          </div>
