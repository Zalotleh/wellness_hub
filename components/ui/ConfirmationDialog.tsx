  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
        <div className={`relative transform overflow-hidden rounded-lg bg-white border-2 ${styles.border} text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg`}>
          {/* Header */}
