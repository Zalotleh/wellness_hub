            ...
            <>
              ...
              <div className="flex gap-2 mb-3">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="w-6 h-6 bg-gray-200 rounded-full animate-pulse" />
                ))}
              </div>
      ...
      <div className="bg-white rounded-xl p-8 max-w-md mx-4 text-center">
        ...
        <div className="mb-6">
          <div className="relative">
            <ChefHat className="w-16 h-16 text-green-600 mx-auto" />
...
export function OptimisticUpdate({ isVisible, action, className = '' }: OptimisticUpdateProps) {
  ...
  return (
    <div className={`fixed top-4 right-4 z-40 ${className}`}>
      <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-3 flex items-center gap-3 min-w-48">
