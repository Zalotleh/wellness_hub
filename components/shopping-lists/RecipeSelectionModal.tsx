      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-800 dark:text-white">Select Recipes</h2>
              <p className="text-gray-600 dark:text-gray-300">Choose recipes to create shopping list from</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <label htmlFor="filterPantryRecipes" className="text-sm text-gray-700 dark:text-gray-300">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {fetchLoading ? (
            <div className="flex items-center justify-center py-12">
              ...
              <span className="ml-3 text-gray-600 dark:text-gray-300">Loading recipes...</span>
            </div>
          ) : error ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-800 dark:text-white mb-2">Error Loading Recipes</h3>
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-green-500 dark:bg-green-600 text-white rounded-lg hover:bg-green-600 dark:hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center space-x-2"
            >
