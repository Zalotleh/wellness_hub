  ...
  if (meals.length === 0) {
    return (
      <div className={cn('text-center py-8', className)}>
        ...
        <p className="text-gray-600 dark:text-gray-200">Add some meals to your meal plan to generate recipes.</p>
      </div>
    );
  }
          ...
          {showBulkActions && (
            <div className="flex items-center space-x-2">
              <button
                ...
                className="text-sm text-gray-600 dark:text-gray-200 hover:text-gray-800 dark:hover:text-gray-100"
              >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      {meal.description && (
                        <p className="text-sm text-gray-600 dark:text-gray-200">{meal.description}</p>
                      )}
                      <span className={cn(
