-- CreateEnum
CREATE TYPE "DefenseSystem" AS ENUM ('ANGIOGENESIS', 'REGENERATION', 'MICROBIOME', 'DNA_PROTECTION', 'IMMUNITY');
...
CREATE TABLE "Progress" (
    ...
    "userId" TEXT NOT NULL,
    "date" DATE NOT NULL,
    "defenseSystem" "DefenseSystem" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Progress_userId_date_defenseSystem_key" ON "Progress"("userId", "date", "defenseSystem");
